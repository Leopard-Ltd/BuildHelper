...
// Set Code Signing Identity
    ...
    private static void SetPlistConfig(string pathToBuiltProject)
    {
        ...
        // allow insecure http IOS
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine("Add allow insecure http IOS has exception. " + e);
            }
#endif
        ...
        Console.WriteLine("IOSPostProcessingBuildTool End SetPlistConfig");
    ...
    private static void SetCapability(string pbxProjectPath, string mainTargetGuid)
    {
        ...
        Console.WriteLine("OnPostProcessBuild SetCapability");
    }
